...
@NamedQueries({
    ...
    , @NamedQuery(name = "Pension.findByNombre", query = "SELECT p FROM Pension p WHERE p.nombre = :nombre")
    , @NamedQuery(name = "Pension.findByActivo", query = "SELECT p FROM Pension p WHERE p.activo = :activo")})
public class Pension implements Serializable {
    ...
    public Pension(Integer id, String nombre) {
        this.id = id;
        this.nombre = nombre;
    }
    ...
    public String toString() {
        return "co.edu.sena.cbi.jpa.entities.Pension[ id=" + id + " ]";
    }
